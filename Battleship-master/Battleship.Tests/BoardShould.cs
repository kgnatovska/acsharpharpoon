...
namespace Battleship.Tests
{
    ...
    public class BoardShould
    {
        ...
        [TestCase(11, 1, Directions.Horizontal)]
        [TestCase(9, 1, Directions.Horizontal)]
        [TestCase(1, 11, Directions.Horizontal)]
        [TestCase(1, 9, Directions.Vertiacal)]
        public void ThrowsArgumentOutOfRangeException_WhenShipIsOutOfBoard(byte x, byte y, Directions direction)
        {
